...
func (p *P2pServer) LoadReqId(reqId int64) (string, bool) {
	cmd, found := requestMap.Load(reqId)
	if !found {
		return "", found
	}
	return cmd.(string), found
}
