...
func (n *Network) InitFsm() {
	...
	var fsmTable = []fsmTableItem{
		...
		{STATE_GOT_SP_LIST, EVENT_RCV_RSP_ACTIVATE, utils.TransitionItem{NewState: STATE_NOT_MINING}},
		{STATE_GOT_SP_LIST, EVENT_RCV_STATUS_ONLINE, utils.TransitionItem{NewState: STATE_REGISTERING, Action: n.StartRegisterToSp}},
