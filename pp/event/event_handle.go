...
func RegisterEventHandle() {
	...
	spbf.Register(header.RspDownloadSliceWrong, RspDownloadSloceWrong)
	...
	spbf.Register(header.ReqDownloadSlicePause, ReqDownloadSlocePause)
	spbf.Register(header.RspDownloadSlicePause, RspDownloadSlocePause)
