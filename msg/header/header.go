...
func GetRspIdFromReqId(reqId uint8) uint8 {
	switch reqId {
	case MSG_ID_REQ_GET_PPLIST:
		return MSG_ID_RSP_GET_PPLIST
	case MSG_ID_REQ_GET_SPLIST:
		return MSG_ID_RSP_GET_SPLIST
	case MSG_ID_REQ_GET_PPSTATUS:
		return MSG_ID_RSP_GET_PPSTATUS
	case MSG_ID_REQ_GET_PPDOWNGRADEINFO:
		return MSG_ID_RSP_GET_PPDOWNGRADEINFO
	case MSG_ID_REQ_GET_WALLETOZ:
		return MSG_ID_RSP_GET_WALLETOZ
	case MSG_ID_REQ_REGISTER:
		return MSG_ID_RSP_REGISTER
	case MSG_ID_REQ_ACTIVATE_PP:
		return MSG_ID_RSP_ACTIVATE_PP
	case MSG_ID_REQ_UPDATE_STAKE_PP:
		return MSG_ID_RSP_UPDATE_STAKE_PP
	case MSG_ID_REQ_STATE_CHANGE_PP:
		return MSG_ID_RSP_STATE_CHANGE_PP
	case MSG_ID_REQ_DEACTIVATE_PP:
		return MSG_ID_RSP_DEACTIVATE_PP
	case MSG_ID_REQ_PREPAY:
		return MSG_ID_RSP_PREPAY
	case MSG_ID_REQ_PREPAID:
		return MSG_ID_RSP_PREPAID
	case MSG_ID_REQ_MINING:
		return MSG_ID_RSP_MINING
	case MSG_ID_REQ_START_MAINTENANCE:
		return MSG_ID_RSP_START_MAINTENANCE
	case MSG_ID_REQ_STOP_MAINTENANCE:
		return MSG_ID_RSP_STOP_MAINTENANCE
	case MSG_ID_REQ_UPLOAD_FILE:
		return MSG_ID_RSP_UPLOAD_FILE
	case MSG_ID_REQ_UPLOAD_FILESLICE:
		return MSG_ID_RSP_UPLOAD_FILESLICE
	case MSG_ID_REQ_BACKUP_FILESLICE:
		return MSG_ID_RSP_BACKUP_FILESLICE
	case MSG_ID_REQ_UPLOAD_SLICES_WRONG:
		return MSG_ID_RSP_UPLOAD_SLICES_WRONG
	case MSG_ID_REQ_REPORT_UPLOAD_SLICE_RESULT:
		return MSG_ID_RSP_REPORT_UPLOAD_SLICE_RESULT
	case MSG_ID_REQ_FIND_MY_FILELIST:
		return MSG_ID_RSP_FIND_MY_FILELIST
	case MSG_ID_REQ_DELETE_FILE:
		return MSG_ID_RSP_DELETE_FILE
	case MSG_ID_REQ_GET_HDINFO:
		return MSG_ID_RSP_GET_HDINFO
	case MSG_ID_REQ_FILE_STORAGEINFO:
		return MSG_ID_RSP_FILE_STORAGEINFO
	case MSG_ID_REQ_DOWNLOAD_SLICE:
		return MSG_ID_RSP_DOWNLOAD_SLICE
	case MSG_ID_REQ_REPORT_DOWNLOAD_RESULT:
		return MSG_ID_RSP_REPORT_DOWNLOAD_RESULT
	case MSG_ID_REQ_DOWNLOAD_TASKINFO:
		return MSG_ID_RSP_DOWNLOAD_TASKINFO
	case MSG_ID_REQ_DOWNLOAD_FILE_WRONG:
		return MSG_ID_RSP_DOWNLOAD_FILE_WRONG
	case MSG_ID_REQ_REGISTER_NEWPP:
		return MSG_ID_RSP_REGISTER_NEWPP
	case MSG_ID_REQ_TRANSFE_RDOWNLOAD:
		return MSG_ID_RSP_TRANSFE_RDOWNLOAD
	case MSG_ID_REQ_TRANSFER_DOWNLOAD_WRONG:
		return MSG_ID_RSP_TRANSFER_DOWNLOAD_WRONG
	case MSG_ID_REQ_REPORT_BACKUP_SLICE_RESULT:
		return MSG_ID_RSP_REPORT_BACKUP_SLICE_RESULT
	case MSG_ID_REQ_FILE_BACKUP_STATUS:
		return MSG_ID_RSP_FILE_BACKUP_STATUS
	case MSG_ID_REQ_FILE_REPLICA_INFO:
		return MSG_ID_RSP_FILE_REPLICA_INFO
	case MSG_ID_REQ_SHARELINK:
		return MSG_ID_RSP_SHARELINK
	case MSG_ID_REQ_SHARE_FILE:
		return MSG_ID_RSP_SHARE_FILE
	case MSG_ID_REQ_DELETE_SHARE:
		return MSG_ID_RSP_DELETE_SHARE
	case MSG_ID_REQ_GET_SHAREFILE:
		return MSG_ID_RSP_GET_SHAREFILE
	case MSG_ID_REQ_SP_LATENCY_CHECK:
		return MSG_ID_RSP_SP_LATENCY_CHECK
	case MSG_ID_REQ_PP_LATENCY_CHECK:
		return MSG_ID_RSP_PP_LATENCY_CHECK
	case MSG_ID_REQ_REPORT_NODESTATUS:
		return MSG_ID_RSP_REPORT_NODESTATUS
	case MSG_ID_REQ_SP_STATUS:
		return MSG_ID_RSP_SP_STATUS
