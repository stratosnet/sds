...
const (
	HeartbeatType_LATENCY_CHECK     HeartbeatType = 0
	HeartbeatType_REGULAR_HEARTBEAT HeartbeatType = 1
)
...
var file_sds_comm_proto_rawDesc = []byte{
	...
	0x41, 0x55, 0x4c, 0x54, 0x10, 0x00, 0x2a, 0x39, 0x0a, 0x0d, 0x48, 0x65, 0x61, 0x72, 0x74, 0x62,
	0x65, 0x61, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x11, 0x0a, 0x0d, 0x4c, 0x41, 0x54, 0x45, 0x4e,
	0x43, 0x59, 0x5f, 0x43, 0x48, 0x45, 0x43, 0x4b, 0x10, 0x00, 0x12, 0x15, 0x0a, 0x11, 0x52, 0x45,
	0x47, 0x55, 0x4c, 0x41, 0x52, 0x5f, 0x48, 0x45, 0x41, 0x52, 0x54, 0x42, 0x45, 0x41, 0x54, 0x10,
...
var file_sds_comm_proto_goTypes = []interface{}{
	...
	(HeartbeatType)(0),        // 6: protos.HeartbeatType
	...
	(*SliceNumAddr)(nil),      // 11: protos.SliceNumAddr
	...
	(*AlbumInfo)(nil),         // 19: protos.AlbumInfo
	(*AlbumNumber)(nil),       // 20: protos.AlbumNumber
	(*CpuStat)(nil),           // 21: protos.CpuStat
	(*MemoryStat)(nil),        // 22: protos.MemoryStat
	(*DiskStat)(nil),          // 23: protos.DiskStat
	(*BandwidthStat)(nil),     // 24: protos.BandwidthStat
}
var file_sds_comm_proto_depIdxs = []int32{
	...
	8,  // 2: protos.SliceNumAddr.pp_info:type_name -> protos.PPBaseInfo
