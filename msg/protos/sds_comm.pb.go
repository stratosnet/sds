...
func (x *IndexNodeBaseInfo) Reset() {
	*x = IndexNodeBaseInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *IndexNodeBaseInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IndexNodeBaseInfo) ProtoMessage() {}

func (x *IndexNodeBaseInfo) ProtoReflect() protoreflect.Message {
	mi := &file_sds_comm_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IndexNodeBaseInfo.ProtoReflect.Descriptor instead.
func (*IndexNodeBaseInfo) Descriptor() ([]byte, []int) {
	return file_sds_comm_proto_rawDescGZIP(), []int{2}
}

func (x *IndexNodeBaseInfo) GetP2PAddress() string {
	if x != nil {
		return x.P2PAddress
	}
	return ""
...
func (x *IndexNodeBaseInfo) GetP2PPubKey() string {
	if x != nil {
		return x.P2PPubKey
	}
	return ""
...
func (x *IndexNodeBaseInfo) GetNetworkAddress() string {
	if x != nil {
		return x.NetworkAddress
	}
	return ""
...
var file_sds_comm_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x22, 0x7d, 0x0a, 0x11, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x4e, 0x6f, 0x64, 0x65, 0x42,
	0x61, 0x73, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x32, 0x70, 0x5f, 0x61,
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x70, 0x32,
	0x70, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x1e, 0x0a, 0x0b, 0x70, 0x32, 0x70, 0x5f,
	0x70, 0x75, 0x62, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70,
	0x32, 0x70, 0x50, 0x75, 0x62, 0x4b, 0x65, 0x79, 0x12, 0x27, 0x0a, 0x0f, 0x6e, 0x65, 0x74, 0x77,
	...
	0x73, 0x22, 0x94, 0x03, 0x0a, 0x08, 0x46, 0x69, 0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1b,
	...
	0x74, 0x61, 0x67, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x65, 0x6e, 0x63, 0x72, 0x79,
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x61, 0x67, 0x22, 0x96, 0x01, 0x0a, 0x0c, 0x53, 0x6c, 0x69,
	0x63, 0x65, 0x4e, 0x75, 0x6d, 0x41, 0x64, 0x64, 0x72, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x6c, 0x69,
	0x63, 0x65, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x0b, 0x73, 0x6c, 0x69, 0x63, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x36, 0x0a, 0x0c,
	...
	0x66, 0x73, 0x65, 0x74, 0x12, 0x2b, 0x0a, 0x07, 0x70, 0x70, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18,
	...
	0x6f, 0x22, 0xd5, 0x01, 0x0a, 0x0d, 0x53, 0x6c, 0x69, 0x63, 0x65, 0x48, 0x61, 0x73, 0x68, 0x41,
...
var file_sds_comm_proto_goTypes = []interface{}{
	...
	(*IndexNodeBaseInfo)(nil), // 7: protos.IndexNodeBaseInfo
...
func file_sds_comm_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sds_comm_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IndexNodeBaseInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
