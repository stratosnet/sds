...
var file_sds_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x52, 0x65, 0x73,
	0x75, 0x6c, 0x74, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x2a, 0x2f, 0x0a, 0x07, 0x50,
...
var file_sds_proto_msgTypes = make([]protoimpl.MessageInfo, 101)
var file_sds_proto_goTypes = []interface{}{
	...
	(*SliceNumAddr)(nil),               // 106: protos.SliceNumAddr
	(*SliceOffsetInfo)(nil),            // 107: protos.SliceOffsetInfo
	(FileSortType)(0),                  // 108: protos.FileSortType
	(*FileIndexes)(nil),                // 109: protos.FileIndexes
	(*DownloadSliceInfo)(nil),          // 110: protos.DownloadSliceInfo
	(DownloadWrongType)(0),             // 111: protos.DownloadWrongType
	(*SliceStorageInfo)(nil),           // 112: protos.SliceStorageInfo
	(HeartbeatType)(0),                 // 113: protos.HeartbeatType
	(*ShareLinkInfo)(nil),              // 114: protos.ShareLinkInfo
	(*CpuStat)(nil),                    // 115: protos.CpuStat
	(*MemoryStat)(nil),                 // 116: protos.MemoryStat
	(*DiskStat)(nil),                   // 117: protos.DiskStat
	(*BandwidthStat)(nil),              // 118: protos.BandwidthStat
}
var file_sds_proto_depIdxs = []int32{
	...
	105, // 11: protos.ReqUploadFile.file_info:type_name -> protos.FileInfo
	102, // 12: protos.ReqUploadFile.my_address:type_name -> protos.PPBaseInfo
	106, // 13: protos.RspUploadFile.pp_list:type_name -> protos.SliceNumAddr
	103, // 14: protos.RspUploadFile.result:type_name -> protos.Result
	106, // 15: protos.ReqUploadFileSlice.slice_num_addr:type_name -> protos.SliceNumAddr
	107, // 16: protos.ReqUploadFileSlice.slice_info:type_name -> protos.SliceOffsetInfo
	103, // 17: protos.RspUploadFileSlice.result:type_name -> protos.Result
	106, // 18: protos.RspUploadFileSlice.slice_num_addr:type_name -> protos.SliceNumAddr
	106, // 19: protos.ReportUploadSliceResult.slice_num_addr:type_name -> protos.SliceNumAddr
	103, // 20: protos.RspReportUploadSliceResult.result:type_name -> protos.Result
	106, // 21: protos.RspReportUploadSliceResult.slice_num_addr:type_name -> protos.SliceNumAddr
	108, // 22: protos.ReqFindMyFileList.file_type:type_name -> protos.FileSortType
	105, // 23: protos.RspFindMyFileList.file_info:type_name -> protos.FileInfo
	103, // 24: protos.RspFindMyFileList.result:type_name -> protos.Result
	109, // 25: protos.ReqFileStorageInfo.file_indexes:type_name -> protos.FileIndexes
	92,  // 26: protos.ReqFileStorageInfo.share_request:type_name -> protos.ReqGetShareFile
	110, // 27: protos.RspFileStorageInfo.slice_info:type_name -> protos.DownloadSliceInfo
	103, // 28: protos.RspFileStorageInfo.result:type_name -> protos.Result
	109, // 29: protos.ReqDownloadFileWrong.file_indexes:type_name -> protos.FileIndexes
	102, // 30: protos.ReqDownloadFileWrong.failed_pp_nodes:type_name -> protos.PPBaseInfo
	107, // 31: protos.ReqDownloadSlice.slice_info:type_name -> protos.SliceOffsetInfo
	107, // 32: protos.RspDownloadSlice.slice_info:type_name -> protos.SliceOffsetInfo
	103, // 33: protos.RspDownloadSlice.result:type_name -> protos.Result
	111, // 34: protos.ReqDownloadSliceWrong.type:type_name -> protos.DownloadWrongType
	110, // 35: protos.RspDownloadSliceWrong.new_slice_info:type_name -> protos.DownloadSliceInfo
	103, // 36: protos.RspDownloadSliceWrong.result:type_name -> protos.Result
	103, // 37: protos.RspDownloadSlicePause.result:type_name -> protos.Result
	110, // 38: protos.ReqReportDownloadResult.slice_info:type_name -> protos.DownloadSliceInfo
	103, // 39: protos.RspReportDownloadResult.result:type_name -> protos.Result
	110, // 40: protos.RspReportDownloadResult.slice_info:type_name -> protos.DownloadSliceInfo
	102, // 41: protos.ReqReportTaskBP.reporter:type_name -> protos.PPBaseInfo
	103, // 42: protos.RspRegisterNewPP.result:type_name -> protos.Result
	102, // 43: protos.ReqActivatePP.pp_info:type_name -> protos.PPBaseInfo
	103, // 44: protos.RspActivatePP.result:type_name -> protos.Result
	103, // 45: protos.RspActivatedPP.result:type_name -> protos.Result
	103, // 46: protos.RspUpdateStakePP.result:type_name -> protos.Result
	103, // 47: protos.RspUpdatedStakePP.result:type_name -> protos.Result
	103, // 48: protos.RspDeactivatePP.result:type_name -> protos.Result
	103, // 49: protos.RspPPRegisteredToSP.result:type_name -> protos.Result
	103, // 50: protos.RspUnbondingPP.result:type_name -> protos.Result
	103, // 51: protos.RspDeactivatedPP.result:type_name -> protos.Result
	103, // 52: protos.RspUnbondingSP.result:type_name -> protos.Result
	103, // 53: protos.RspDeactivatedSP.result:type_name -> protos.Result
	103, // 54: protos.RspPrepay.result:type_name -> protos.Result
	103, // 55: protos.RspPrepaid.result:type_name -> protos.Result
	103, // 56: protos.RspDeleteFile.result:type_name -> protos.Result
	112, // 57: protos.ReqFileSliceBackupNotice.slice_storage_info:type_name -> protos.SliceStorageInfo
	102, // 58: protos.ReqFileSliceBackupNotice.pp_info:type_name -> protos.PPBaseInfo
	102, // 59: protos.ReqReportBackupSliceResult.pp_info:type_name -> protos.PPBaseInfo
	103, // 60: protos.RspReportBackupSliceResult.result:type_name -> protos.Result
	102, // 61: protos.ReqTransferDownload.new_pp:type_name -> protos.PPBaseInfo
	102, // 62: protos.ReqTransferDownload.original_pp:type_name -> protos.PPBaseInfo
	112, // 63: protos.ReqTransferDownload.slice_storage_info:type_name -> protos.SliceStorageInfo
	103, // 64: protos.RspTransferDownload.result:type_name -> protos.Result
	103, // 65: protos.RspTransferDownloadResult.result:type_name -> protos.Result
	103, // 66: protos.RspDeleteSlice.result:type_name -> protos.Result
	113, // 67: protos.ReqLatencyCheck.hb_type:type_name -> protos.HeartbeatType
	113, // 68: protos.RspLatencyCheck.hb_type:type_name -> protos.HeartbeatType
	...
	103, // 71: protos.RspDownloadTaskInfo.result:type_name -> protos.Result
	114, // 72: protos.RspShareLink.share_info:type_name -> protos.ShareLinkInfo
	103, // 73: protos.RspShareLink.result:type_name -> protos.Result
	103, // 74: protos.RspShareFile.result:type_name -> protos.Result
	103, // 75: protos.RspDeleteShare.result:type_name -> protos.Result
	92,  // 76: protos.RspGetShareFile.share_request:type_name -> protos.ReqGetShareFile
	103, // 77: protos.RspGetShareFile.result:type_name -> protos.Result
	105, // 78: protos.RspGetShareFile.file_info:type_name -> protos.FileInfo
	115, // 79: protos.ReqReportNodeStatus.cpu:type_name -> protos.CpuStat
	116, // 80: protos.ReqReportNodeStatus.memory:type_name -> protos.MemoryStat
	117, // 81: protos.ReqReportNodeStatus.disk:type_name -> protos.DiskStat
	118, // 82: protos.ReqReportNodeStatus.bandwidth:type_name -> protos.BandwidthStat
	102, // 83: protos.ReqGetPPStatus.my_address:type_name -> protos.PPBaseInfo
	103, // 84: protos.RspGetPPStatus.result:type_name -> protos.Result
	103, // 85: protos.RspGetWalletOz.result:type_name -> protos.Result
	103, // 86: protos.RspReportNodeStatus.result:type_name -> protos.Result
