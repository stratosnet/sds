...
var file_sds_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c,
	0x74, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0xf9, 0x01, 0x0a, 0x0f, 0x52, 0x65,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0c, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x50, 0x75,
	...
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x73,
	0x68, 0x61, 0x72, 0x65, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x17, 0x0a, 0x07,
	0x73, 0x61, 0x76, 0x65, 0x5f, 0x61, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73,
	0x61, 0x76, 0x65, 0x41, 0x73, 0x22, 0xee, 0x01, 0x0a, 0x0f, 0x52, 0x73, 0x70, 0x47, 0x65, 0x74,
...
var file_sds_proto_goTypes = []interface{}{
	...
	(*SliceHashAddr)(nil),              // 104: protos.SliceHashAddr
	(*SliceOffset)(nil),                // 105: protos.SliceOffset
	(UploadType)(0),                    // 106: protos.UploadType
...
var file_sds_proto_depIdxs = []int32{
	...
	100, // 11: protos.ReqStartMaintenance.address:type_name -> protos.PPBaseInfo
	101, // 12: protos.RspStartMaintenance.result:type_name -> protos.Result
	100, // 13: protos.ReqStopMaintenance.address:type_name -> protos.PPBaseInfo
	101, // 14: protos.RspStopMaintenance.result:type_name -> protos.Result
	103, // 15: protos.ReqUploadFile.file_info:type_name -> protos.FileInfo
	104, // 16: protos.ReqUploadFile.slices:type_name -> protos.SliceHashAddr
	100, // 17: protos.ReqUploadFile.my_address:type_name -> protos.PPBaseInfo
	104, // 18: protos.RspUploadFile.slices:type_name -> protos.SliceHashAddr
	101, // 19: protos.RspUploadFile.result:type_name -> protos.Result
	13,  // 20: protos.ReqUploadFileSlice.rsp_upload_file:type_name -> protos.RspUploadFile
	105, // 21: protos.ReqUploadFileSlice.piece_offset:type_name -> protos.SliceOffset
	101, // 22: protos.RspUploadFileSlice.result:type_name -> protos.Result
	104, // 23: protos.RspUploadFileSlice.slice:type_name -> protos.SliceHashAddr
	106, // 24: protos.ReqUploadSlicesWrong.upload_type:type_name -> protos.UploadType
	100, // 25: protos.ReqUploadSlicesWrong.my_address:type_name -> protos.PPBaseInfo
	100, // 26: protos.ReqUploadSlicesWrong.excluded_destinations:type_name -> protos.PPBaseInfo
	104, // 27: protos.ReqUploadSlicesWrong.slices:type_name -> protos.SliceHashAddr
	101, // 28: protos.RspUploadSlicesWrong.result:type_name -> protos.Result
	106, // 29: protos.RspUploadSlicesWrong.upload_type:type_name -> protos.UploadType
	104, // 30: protos.RspUploadSlicesWrong.slices:type_name -> protos.SliceHashAddr
	59,  // 31: protos.ReqBackupFileSlice.rsp_backup_file:type_name -> protos.RspBackupStatus
	105, // 32: protos.ReqBackupFileSlice.piece_offset:type_name -> protos.SliceOffset
	101, // 33: protos.RspBackupFileSlice.result:type_name -> protos.Result
	104, // 34: protos.RspBackupFileSlice.slice:type_name -> protos.SliceHashAddr
	104, // 35: protos.ReportUploadSliceResult.slice:type_name -> protos.SliceHashAddr
	101, // 36: protos.RspReportUploadSliceResult.result:type_name -> protos.Result
	104, // 37: protos.RspReportUploadSliceResult.slice:type_name -> protos.SliceHashAddr
	107, // 38: protos.ReqFindMyFileList.file_type:type_name -> protos.FileSortType
	103, // 39: protos.RspFindMyFileList.file_info:type_name -> protos.FileInfo
	101, // 40: protos.RspFindMyFileList.result:type_name -> protos.Result
	108, // 41: protos.ReqFileStorageInfo.file_indexes:type_name -> protos.FileIndexes
	88,  // 42: protos.ReqFileStorageInfo.share_request:type_name -> protos.ReqGetShareFile
	109, // 43: protos.RspFileStorageInfo.slice_info:type_name -> protos.DownloadSliceInfo
	101, // 44: protos.RspFileStorageInfo.result:type_name -> protos.Result
	101, // 45: protos.RspFileReplicaInfo.result:type_name -> protos.Result
	108, // 46: protos.ReqDownloadFileWrong.file_indexes:type_name -> protos.FileIndexes
	100, // 47: protos.ReqDownloadFileWrong.failed_pp_nodes:type_name -> protos.PPBaseInfo
	26,  // 48: protos.ReqDownloadSlice.rsp_file_storage_info:type_name -> protos.RspFileStorageInfo
	110, // 49: protos.RspDownloadSlice.slice_info:type_name -> protos.SliceOffsetInfo
	101, // 50: protos.RspDownloadSlice.result:type_name -> protos.Result
	101, // 51: protos.RspDownloadSlicePause.result:type_name -> protos.Result
	109, // 52: protos.ReqReportDownloadResult.slice_info:type_name -> protos.DownloadSliceInfo
	101, // 53: protos.RspReportDownloadResult.result:type_name -> protos.Result
	109, // 54: protos.RspReportDownloadResult.slice_info:type_name -> protos.DownloadSliceInfo
	100, // 55: protos.ReqReportTaskBP.reporter:type_name -> protos.PPBaseInfo
	101, // 56: protos.RspRegisterNewPP.result:type_name -> protos.Result
	100, // 57: protos.ReqActivatePP.pp_info:type_name -> protos.PPBaseInfo
	101, // 58: protos.RspActivatePP.result:type_name -> protos.Result
	101, // 59: protos.RspUpdateDepositPP.result:type_name -> protos.Result
	101, // 60: protos.NoticeUpdatedDepositPP.result:type_name -> protos.Result
	101, // 61: protos.RspStateChangePP.result:type_name -> protos.Result
	101, // 62: protos.RspDeactivatePP.result:type_name -> protos.Result
	101, // 63: protos.NoticeUnbondingPP.result:type_name -> protos.Result
	101, // 64: protos.NoticeDeactivatedPP.result:type_name -> protos.Result
	101, // 65: protos.RspUnbondingSP.result:type_name -> protos.Result
	101, // 66: protos.RspPrepay.result:type_name -> protos.Result
	101, // 67: protos.RspDeleteFile.result:type_name -> protos.Result
	111, // 68: protos.NoticeFileSliceBackup.slice_storage_info:type_name -> protos.SliceStorageInfo
	100, // 69: protos.NoticeFileSliceBackup.pp_info:type_name -> protos.PPBaseInfo
	100, // 70: protos.ReqReportBackupSliceResult.pp_info:type_name -> protos.PPBaseInfo
	101, // 71: protos.RspReportBackupSliceResult.result:type_name -> protos.Result
	100, // 72: protos.ReqBackupStatus.address:type_name -> protos.PPBaseInfo
	101, // 73: protos.RspBackupStatus.result:type_name -> protos.Result
	104, // 74: protos.RspBackupStatus.slices:type_name -> protos.SliceHashAddr
	55,  // 75: protos.ReqTransferDownload.notice_file_slice_backup:type_name -> protos.NoticeFileSliceBackup
	100, // 76: protos.ReqTransferDownload.new_pp:type_name -> protos.PPBaseInfo
	101, // 77: protos.RspTransferDownload.result:type_name -> protos.Result
	101, // 78: protos.RspTransferDownloadResult.result:type_name -> protos.Result
	100, // 79: protos.ReqTransferDownloadWrong.new_pp:type_name -> protos.PPBaseInfo
	100, // 80: protos.ReqTransferDownloadWrong.original_pp:type_name -> protos.PPBaseInfo
	111, // 81: protos.ReqTransferDownloadWrong.slice_storage_info:type_name -> protos.SliceStorageInfo
	78,  // 82: protos.RspBlockCheck.block_list:type_name -> protos.BlockCheckInfo
	101, // 83: protos.RspDownloadTaskInfo.result:type_name -> protos.Result
	112, // 84: protos.RspShareLink.share_info:type_name -> protos.ShareLinkInfo
	101, // 85: protos.RspShareLink.result:type_name -> protos.Result
	101, // 86: protos.RspShareFile.result:type_name -> protos.Result
	101, // 87: protos.RspDeleteShare.result:type_name -> protos.Result
	88,  // 88: protos.RspGetShareFile.share_request:type_name -> protos.ReqGetShareFile
	101, // 89: protos.RspGetShareFile.result:type_name -> protos.Result
	103, // 90: protos.RspGetShareFile.file_info:type_name -> protos.FileInfo
	113, // 91: protos.ReqReportNodeStatus.cpu:type_name -> protos.CpuStat
	114, // 92: protos.ReqReportNodeStatus.memory:type_name -> protos.MemoryStat
	115, // 93: protos.ReqReportNodeStatus.disk:type_name -> protos.DiskStat
	116, // 94: protos.ReqReportNodeStatus.bandwidth:type_name -> protos.BandwidthStat
	101, // 95: protos.RspReportNodeStatus.result:type_name -> protos.Result
	100, // 96: protos.ReqGetPPDowngradeInfo.my_address:type_name -> protos.PPBaseInfo
	101, // 97: protos.RspGetPPDowngradeInfo.result:type_name -> protos.Result
	100, // 98: protos.ReqGetPPStatus.my_address:type_name -> protos.PPBaseInfo
	101, // 99: protos.RspGetPPStatus.result:type_name -> protos.Result
	...
	101, // 102: protos.RspGetWalletOz.result:type_name -> protos.Result
