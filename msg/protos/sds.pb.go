...
var file_sds_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x65, 0x48, 0x61, 0x73, 0x68, 0x22, 0xdb, 0x02, 0x0a, 0x13, 0x52, 0x65, 0x71, 0x54,
	...
	0x73, 0x68, 0x22, 0x56, 0x0a, 0x0c, 0x52, 0x65, 0x71, 0x47, 0x65, 0x74, 0x48, 0x44, 0x49, 0x6e,
	...
	0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0xb1, 0x01, 0x0a, 0x0f, 0x52,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x06, 0x72, 0x65, 0x73,
	0x75, 0x6c, 0x74, 0x22, 0x37, 0x0a, 0x0e, 0x52, 0x65, 0x71, 0x47, 0x65, 0x74, 0x57, 0x61, 0x6c,
	0x6c, 0x65, 0x74, 0x4f, 0x7a, 0x12, 0x25, 0x0a, 0x0e, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x5f,
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x77,
	0x61, 0x6c, 0x6c, 0x65, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x7c, 0x0a, 0x0e,
	...
	0x61, 0x6c, 0x6c, 0x65, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0d, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x12, 0x26, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x52, 0x65, 0x73, 0x75,
...
var file_sds_proto_goTypes = []interface{}{
	...
	(*ReqDeleteSlice)(nil),             // 68: protos.ReqDeleteSlice
	(*RspDeleteSlice)(nil),             // 69: protos.RspDeleteSlice
	(*ReqLatencyCheck)(nil),            // 70: protos.ReqLatencyCheck
	(*RspLatencyCheck)(nil),            // 71: protos.RspLatencyCheck
	...
	(*RelayMessage)(nil),               // 94: protos.RelayMessage
	(*ReqTransferBLSSignature)(nil),    // 95: protos.ReqTransferBLSSignature
	(*ReqReportNodeStatus)(nil),        // 96: protos.ReqReportNodeStatus
	(*ReqGetPPStatus)(nil),             // 97: protos.ReqGetPPStatus
	(*RspGetPPStatus)(nil),             // 98: protos.RspGetPPStatus
	(*ReqGetWalletOz)(nil),             // 99: protos.ReqGetWalletOz
	(*RspGetWalletOz)(nil),             // 100: protos.RspGetWalletOz
	(*RspReportNodeStatus)(nil),        // 101: protos.RspReportNodeStatus
	(*RspBadVersion)(nil),              // 102: protos.RspBadVersion
	(*PPBaseInfo)(nil),                 // 103: protos.PPBaseInfo
	(*Result)(nil),                     // 104: protos.Result
	(*SPBaseInfo)(nil),                 // 105: protos.SPBaseInfo
	(*FileInfo)(nil),                   // 106: protos.FileInfo
	(*SliceNumAddr)(nil),               // 107: protos.SliceNumAddr
	(*SliceOffsetInfo)(nil),            // 108: protos.SliceOffsetInfo
	...
	(DownloadWrongType)(0),             // 112: protos.DownloadWrongType
...
var file_sds_proto_depIdxs = []int32{
	103, // 0: protos.ReqGetPPList.my_address:type_name -> protos.PPBaseInfo
	103, // 1: protos.RspGetPPList.pp_list:type_name -> protos.PPBaseInfo
	104, // 2: protos.RspGetPPList.result:type_name -> protos.Result
	103, // 3: protos.ReqGetSPList.my_address:type_name -> protos.PPBaseInfo
	105, // 4: protos.RspGetSPList.sp_list:type_name -> protos.SPBaseInfo
	104, // 5: protos.RspGetSPList.result:type_name -> protos.Result
	103, // 6: protos.ReqRegister.address:type_name -> protos.PPBaseInfo
	103, // 7: protos.ReqRegister.my_address:type_name -> protos.PPBaseInfo
	104, // 8: protos.RspRegister.result:type_name -> protos.Result
	103, // 9: protos.ReqMining.address:type_name -> protos.PPBaseInfo
	104, // 10: protos.RspMining.result:type_name -> protos.Result
	106, // 11: protos.ReqUploadFile.file_info:type_name -> protos.FileInfo
	103, // 12: protos.ReqUploadFile.my_address:type_name -> protos.PPBaseInfo
	107, // 13: protos.RspUploadFile.pp_list:type_name -> protos.SliceNumAddr
	104, // 14: protos.RspUploadFile.result:type_name -> protos.Result
	107, // 15: protos.ReqUploadFileSlice.slice_num_addr:type_name -> protos.SliceNumAddr
	108, // 16: protos.ReqUploadFileSlice.slice_info:type_name -> protos.SliceOffsetInfo
	104, // 17: protos.RspUploadFileSlice.result:type_name -> protos.Result
	107, // 18: protos.RspUploadFileSlice.slice_num_addr:type_name -> protos.SliceNumAddr
	107, // 19: protos.ReportUploadSliceResult.slice_num_addr:type_name -> protos.SliceNumAddr
	104, // 20: protos.RspReportUploadSliceResult.result:type_name -> protos.Result
	107, // 21: protos.RspReportUploadSliceResult.slice_num_addr:type_name -> protos.SliceNumAddr
	109, // 22: protos.ReqFindMyFileList.file_type:type_name -> protos.FileSortType
	106, // 23: protos.RspFindMyFileList.file_info:type_name -> protos.FileInfo
	104, // 24: protos.RspFindMyFileList.result:type_name -> protos.Result
	110, // 25: protos.ReqFileStorageInfo.file_indexes:type_name -> protos.FileIndexes
	92,  // 26: protos.ReqFileStorageInfo.share_request:type_name -> protos.ReqGetShareFile
	111, // 27: protos.RspFileStorageInfo.slice_info:type_name -> protos.DownloadSliceInfo
	104, // 28: protos.RspFileStorageInfo.result:type_name -> protos.Result
	110, // 29: protos.ReqDownloadFileWrong.file_indexes:type_name -> protos.FileIndexes
	103, // 30: protos.ReqDownloadFileWrong.failed_pp_nodes:type_name -> protos.PPBaseInfo
	108, // 31: protos.ReqDownloadSlice.slice_info:type_name -> protos.SliceOffsetInfo
	108, // 32: protos.RspDownloadSlice.slice_info:type_name -> protos.SliceOffsetInfo
	104, // 33: protos.RspDownloadSlice.result:type_name -> protos.Result
	112, // 34: protos.ReqDownloadSliceWrong.type:type_name -> protos.DownloadWrongType
	111, // 35: protos.RspDownloadSliceWrong.new_slice_info:type_name -> protos.DownloadSliceInfo
	104, // 36: protos.RspDownloadSliceWrong.result:type_name -> protos.Result
	104, // 37: protos.RspDownloadSlicePause.result:type_name -> protos.Result
	111, // 38: protos.ReqReportDownloadResult.slice_info:type_name -> protos.DownloadSliceInfo
	104, // 39: protos.RspReportDownloadResult.result:type_name -> protos.Result
	111, // 40: protos.RspReportDownloadResult.slice_info:type_name -> protos.DownloadSliceInfo
	103, // 41: protos.ReqReportTaskBP.reporter:type_name -> protos.PPBaseInfo
	104, // 42: protos.RspRegisterNewPP.result:type_name -> protos.Result
	103, // 43: protos.ReqActivatePP.pp_info:type_name -> protos.PPBaseInfo
	104, // 44: protos.RspActivatePP.result:type_name -> protos.Result
	104, // 45: protos.RspActivatedPP.result:type_name -> protos.Result
	104, // 46: protos.RspUpdateStakePP.result:type_name -> protos.Result
	104, // 47: protos.RspUpdatedStakePP.result:type_name -> protos.Result
	104, // 48: protos.RspDeactivatePP.result:type_name -> protos.Result
	104, // 49: protos.RspPPRegisteredToSP.result:type_name -> protos.Result
	104, // 50: protos.RspUnbondingPP.result:type_name -> protos.Result
	104, // 51: protos.RspDeactivatedPP.result:type_name -> protos.Result
	104, // 52: protos.RspUnbondingSP.result:type_name -> protos.Result
	104, // 53: protos.RspDeactivatedSP.result:type_name -> protos.Result
	104, // 54: protos.RspPrepay.result:type_name -> protos.Result
	104, // 55: protos.RspPrepaid.result:type_name -> protos.Result
	104, // 56: protos.RspDeleteFile.result:type_name -> protos.Result
	113, // 57: protos.ReqFileSliceBackupNotice.slice_storage_info:type_name -> protos.SliceStorageInfo
	103, // 58: protos.ReqFileSliceBackupNotice.pp_info:type_name -> protos.PPBaseInfo
	103, // 59: protos.ReqReportBackupSliceResult.pp_info:type_name -> protos.PPBaseInfo
	104, // 60: protos.RspReportBackupSliceResult.result:type_name -> protos.Result
	103, // 61: protos.ReqTransferDownload.new_pp:type_name -> protos.PPBaseInfo
	103, // 62: protos.ReqTransferDownload.original_pp:type_name -> protos.PPBaseInfo
	113, // 63: protos.ReqTransferDownload.slice_storage_info:type_name -> protos.SliceStorageInfo
	104, // 64: protos.RspTransferDownload.result:type_name -> protos.Result
	104, // 65: protos.RspTransferDownloadResult.result:type_name -> protos.Result
	104, // 66: protos.RspDeleteSlice.result:type_name -> protos.Result
	114, // 67: protos.ReqLatencyCheck.hb_type:type_name -> protos.HeartbeatType
	114, // 68: protos.RspLatencyCheck.hb_type:type_name -> protos.HeartbeatType
	5,   // 69: protos.RspBPBLSPublicKey.bp_info:type_name -> protos.ReqRegister
	82,  // 70: protos.RspBlockCheck.block_list:type_name -> protos.BlockCheckInfo
	104, // 71: protos.RspDownloadTaskInfo.result:type_name -> protos.Result
	115, // 72: protos.RspShareLink.share_info:type_name -> protos.ShareLinkInfo
	104, // 73: protos.RspShareLink.result:type_name -> protos.Result
	104, // 74: protos.RspShareFile.result:type_name -> protos.Result
	104, // 75: protos.RspDeleteShare.result:type_name -> protos.Result
	92,  // 76: protos.RspGetShareFile.share_request:type_name -> protos.ReqGetShareFile
	104, // 77: protos.RspGetShareFile.result:type_name -> protos.Result
	106, // 78: protos.RspGetShareFile.file_info:type_name -> protos.FileInfo
	116, // 79: protos.ReqReportNodeStatus.cpu:type_name -> protos.CpuStat
	117, // 80: protos.ReqReportNodeStatus.memory:type_name -> protos.MemoryStat
	118, // 81: protos.ReqReportNodeStatus.disk:type_name -> protos.DiskStat
	119, // 82: protos.ReqReportNodeStatus.bandwidth:type_name -> protos.BandwidthStat
	103, // 83: protos.ReqGetPPStatus.my_address:type_name -> protos.PPBaseInfo
	104, // 84: protos.RspGetPPStatus.result:type_name -> protos.Result
	104, // 85: protos.RspGetWalletOz.result:type_name -> protos.Result
	104, // 86: protos.RspReportNodeStatus.result:type_name -> protos.Result
