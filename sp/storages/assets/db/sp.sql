...
CREATE TABLE `file_slice_download` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `slice_hash` char(64) NOT NULL DEFAULT '' ,
  `from_p2p_address` char(256) NOT NULL DEFAULT '' COMMENT 'PP P2P address',
  `from_wallet_address` char(42) NOT NULL DEFAULT '' COMMENT 'PP wallet address',
  `to_p2p_address` char(256) NOT NULL DEFAULT '' COMMENT 'P P2P address',
...
CREATE TABLE `transfer_record` (
  ...
  `from_p2p_address` char(256) NOT NULL DEFAULT '' COMMENT 'origin PP P2P address',
  ...
  `to_p2p_address` char(256) NOT NULL DEFAULT '' COMMENT 'target PP P2P address',
...
CREATE TABLE `user` (
  ...
  `p2p_address` char(256) NOT NULL DEFAULT '' COMMENT 'p2p key address',
