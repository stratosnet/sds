...
const (
	...
	MSG_TYPE_UPDATE_RESOURCE_NODE_STAKE = "/stratos.register.v1.MsgUpdateResourceNodeStake"
	MSG_TYPE_REMOVE_RESOURCE_NODE       = "/stratos.register.v1.MsgRemoveResourceNode"
	//MSG_TYPE_COMPLETE_UNBONDING_RESOURCE_NODE = "/stratos.register.v1.MsgCreateResourceNode"
	MSG_TYPE_CREATE_META_NODE              = "/stratos.register.v1.MsgCreateMetaNode"
	MSG_TYPE_UPDATE_META_NODE_STAKE        = "/stratos.register.v1.MsgUpdateMetaNodeStake"
	MSG_TYPE_REMOVE_META_NODE              = "/stratos.register.v1.MsgRemoveMetaNode"
	MSG_TYPE_WITHDRAWN_META_NODE_REG_STAKE = "/stratos.register.v1.MsgWithdrawMetaNodeRegistrationStake"
	//MSG_TYPE_COMPLETE_UNBONDING_META_NODE     = "/stratos.register.v1.MsgCreateResourceNode"
