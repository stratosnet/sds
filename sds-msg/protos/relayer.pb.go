...
var file_relayer_proto_rawDesc = []byte{
	...
	0x6f, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x22, 0x85, 0x01, 0x0a, 0x15, 0x52, 0x65, 0x71, 0x57,
	0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x6e, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x53,
	...
	0x73, 0x73, 0x12, 0x32, 0x0a, 0x15, 0x75, 0x6e, 0x62, 0x6f, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f,
	0x6d, 0x61, 0x74, 0x75, 0x72, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x3f, 0x0a, 0x15, 0x52, 0x73, 0x70, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x6e, 0x44,
	0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x53, 0x50, 0x12, 0x26, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75,
	...
	0x74, 0x22, 0x71, 0x0a, 0x0a, 0x52, 0x65, 0x71, 0x50, 0x72, 0x65, 0x70, 0x61, 0x69, 0x64, 0x12,
	...
	0x48, 0x61, 0x73, 0x68, 0x22, 0x36, 0x0a, 0x0c, 0x52, 0x65, 0x6c, 0x61, 0x79, 0x4d, 0x65, 0x73,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0x2a, 0x5a, 0x28,
...
var file_relayer_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_relayer_proto_goTypes = []interface{}{
	...
	(*ReqWithdrawnDepositSP)(nil), // 9: protos.ReqWithdrawnDepositSP
	(*RspWithdrawnDepositSP)(nil), // 10: protos.RspWithdrawnDepositSP
	(*ReqDeactivatedSP)(nil),      // 11: protos.ReqDeactivatedSP
	(*RspDeactivatedSP)(nil),      // 12: protos.RspDeactivatedSP
	(*ReqPrepaid)(nil),            // 13: protos.ReqPrepaid
	(*RelayMessage)(nil),          // 14: protos.RelayMessage
	(*Result)(nil),                // 15: protos.Result
}
var file_relayer_proto_depIdxs = []int32{
	15, // 0: protos.RspActivatedPP.result:type_name -> protos.Result
	15, // 1: protos.RspWithdrawnDepositSP.result:type_name -> protos.Result
	15, // 2: protos.RspDeactivatedSP.result:type_name -> protos.Result
...
func file_relayer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_relayer_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReqWithdrawnDepositSP); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_relayer_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RspWithdrawnDepositSP); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
